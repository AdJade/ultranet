...
var (
	...
	GenesisBlockHashHex = "b1b4f9633a9f1ca6db9ba6c04676cfcf3f281a888baf2f0917bf3f7042d0b0f5"
)
...
var UltranetMainnetParams = UltranetParams{
	...
	MinChainWorkHex: "00000000000000000000000000000000000000000000000000000000fb55a6d2",
	...
	// current tip.
	// FIXME: Set a reasonable value for Bitcoin min chain work.
	// Run with --v=2 and look for "CumWork" output from bitcoin_manager.go
	BitcoinMinChainWorkHex: "0000000000000000000000000000000000000000006dea65f958958679213a90",
	...
	BitcoinBurnAddress:       "1ESiHCZQEY1srtrYGfgcRGxfKjHu9wPU94",
...
var UltranetTestnetParams = UltranetParams{
	...
	BitcoinBurnAddress:            "mtxfaFeP3ZT8e1L9zEezFCAzBitc9Z4KBV",
	BitcoinExchangeFeeBasisPoints: 10,
	...
	BitcoinStartBlockNode: NewBlockNode(
		nil,
		mustDecodeHexBlockHashBitcoin("000000000000002ac6c1d3b33ad89d967843ad45986d8bbcb74bd6bdf94caa01"),
		1665216,
		_difficultyBitsToHash(436312585),
